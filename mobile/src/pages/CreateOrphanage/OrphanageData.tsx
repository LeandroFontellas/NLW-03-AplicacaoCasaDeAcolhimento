...
export default function OrphanageData() {
  ...
  async function handleCreateOrphanage(){
    ...
    images.forEach((image,index)=>{
      data.append('images',{
        name: `image_${index}.jpg`,//bug aqui que n tem concerto ainda
        type: 'image/jpg',
        uri: image,
      }as any)//colocando as any pra concerta ele
    })
  ...
  async function handleSelectImages(){
    ...
    if(status !== 'granted'){
      alert('Sem acesso as fotos não podemos inserir fotos :/')
      return
    }
    const result = await ImagePicker.launchImageLibraryAsync({
      allowsEditing: true,
      quality: 1,
      mediaTypes: ImagePicker.MediaTypeOptions.Images,//queremos apenas imagens e nao videos
    })
